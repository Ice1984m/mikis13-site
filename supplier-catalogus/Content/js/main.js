    ...
    var Simple = {
        ...
        pageLoadAnim: function() {
            ...
            if ($("#page-loader").length) {
                $("#page-loader").delay(700).fadeOut(800,
                    function() {
                        $(this).remove();
                    });
            }
        ...
        mobileMenuDropdownFix: function() {
            if (typeof Modernizr === "object" &&
                (Modernizr.mq("only all and (max-width: 767px)") || Modernizr.touchevents)) {
                $(".navbar-nav").not(".nav-overlay").find(".dropdown-toggle").on("click",
                    function(e) {
        ...
        overlayMenuDropdownFix: function() {
            ...
            $(".nav-overlay").find(".dropdown-toggle").on("click",
                function(e) {
                    var parent = $(this).closest("li");
                    // close all the siblings and their children
                    parent.siblings().removeClass("open").find("li").removeClass("open");
            ...
            $(document).on("click",
                ...
                function() {
                    $(".owl-carousel.product-gallery")
                        .trigger("to.owl.carousel", [$(this).data("position"), 250, true]);
                });
            $(".owl-carousel.product-gallery").on("translated.owl.carousel",
                function() {
        ...
        productZoom: function() {
            ...
            if ($.fn.elevateZoom) {
                ...
                $(".product-gallery").find("a").on("click",
                    function(e) {
        ...
        flickerFeed: function() {
            ...
            if ($.fn.jflickrfeed) {
                $(".flickr-widget-list").jflickrfeed({
                    ...
                    itemTemplate: "<li>" +
                        '<a href="{{image}}" target="_blank" title="{{title}}">' +
        ...
        sliderText: function(slider, currency) {
            ...
            slider.noUiSlider.on("update",
                function(values, handle) {
                    divs[handle].innerHTML =
                        (currencyVar) ? (currencyVar + values[handle]) : Math.round(values[handle]);
                });
        },
        ...
        isotopeFilter: function() {
            ...
            filtersContainer.find("a").on("click",
                function(e) {
                    var $this = $(this),
